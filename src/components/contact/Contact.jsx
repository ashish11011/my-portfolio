...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_2g7ng1l', 'template_p7gpfwd', form.current, {
        publicKey: '_xL9wWlYWfmpbmXr0',
      })
      .then(
        () => {
          setSuccess(true)
    ...
    <motion.div className='contact' variants={variants} initial="initial" whileInView="animate" >
      <motion.div className='textContainer' variants={variants} >
        ...
        <motion.div variants={variants}  className='item' >
            <h2>Mail</h2>
            <span>bishnoi11011@gmail.com</span>
        </motion.div>
        <motion.div variants={variants}  className='item' >
            <h2>Address</h2>
            <span>V.P.O Duttranwali, Tech- Abohar, Dist- Fazilka Punjab </span>
        </motion.div>
        <motion.div variants={variants}  className='item' >
            <h2>Phone</h2>
            <span>+91 6239565852</span>
        </motion.div>
      </motion.div>
